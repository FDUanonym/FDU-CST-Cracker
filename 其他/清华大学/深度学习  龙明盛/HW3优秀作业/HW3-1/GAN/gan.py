...
def show_images(images, iter_num, model_name):
    """
    ...
    for i, img in enumerate(images):
        ...
        plt.savefig('./checkpoints/{}_{}.png'.format(model_name, iter_num+1))
    return
...
for iter_num in range(len(images)):
    show_images(images[iter_num], iter_num, model_name)
